...
func (postgres PostgresDB) CreateNewCustomer(newCustomer CustomerEntity, now time.Time) (CustomerEntity, error) {
	newID := postgres.getNewID()
...
func (postgres PostgresDB) ListCustomer() ([]CustomerEntity, error) {
...
func (postgres PostgresDB) GetCustomerByID(id string) (CustomerEntity, error) {
	var customer CustomerEntity
...
func (postgres PostgresDB) Update(id string, update CustomerEntity, now time.Time) error {
...
func (postgres PostgresDB) getNewID() (ID string) {
